/*全国预测数据*/
CREATE TABLE test_all AS
SELECT 0 AS watch,a.item_id,0 AS label,
...
FROM(
SELECT a.* FROM(
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days=1)a GROUP BY item_id
...
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days<=2)a GROUP BY item_id
...
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days<=3)a GROUP BY item_id
...
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days<=5)a GROUP BY item_id
...
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days<=7)a GROUP BY item_id
...
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days<=9)a GROUP BY item_id
...
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days<=11)a GROUP BY item_id
...
SELECT a.*,DATEDIFF('2015/12/28',DATE)AS days FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0)a WHERE days<=14)a GROUP BY item_id
...
FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0 GROUP BY cate_id
...
FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0 GROUP BY cate_level_id
...
FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0 GROUP BY brand_id
...
FROM(
SELECT a.*,FLOOR((DATEDIFF('2015/12/28',DATE)-1)/14) AS watch FROM(
SELECT * FROM item_feature )a)a WHERE watch=0 GROUP BY supplier_id
