...
def pipeline():
        ...
        model = GradientBoostingRegressor(loss='lad',learning_rate=0.01,n_estimators=400,subsample=0.75,max_depth=5,random_state=1024, max_features=0.75)
	...
	val_a_b['pred'] = model.predict(val_x)
        val_a_b.to_csv('gbrt_2.csv',index=None)
